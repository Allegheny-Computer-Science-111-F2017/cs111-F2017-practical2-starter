...
if [ "$CHECK" = true ]; then
  ...
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicaltwo/ \
                                     --checkfiles ComputeMoonDistance.java --singlecomments 2 --multicomments 2 --language Java
  determine_exit_code $?
  # --> GatorGrader CHECK: the "new Date()" fragment exists in the code at least once
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicaltwo \
                                     --checkfiles ComputeMoonDistance.java --fragments "new Date()" --fragmentcounts 1
  determine_exit_code $?
  # --> GatorGrader CHECK: at least 4 "println()" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicaltwo \
                                     --checkfiles ComputeMoonDistance.java --fragments "println(" --fragmentcounts 4
  determine_exit_code $?
  ...
  python3 gatorgrader/gatorgrader.py --nowelcome --commands "gradle run" --fragments 420384800 --languages Java
  determine_exit_code $?
  echo ""
